...
#	postscript(paste(i,".eps", sep=""), width=7, height=7)
	...
	eafplot( data[,1:2],sets=data[,3],groups=data[,4], percentiles=c(50), col=colors, lty = c("solid","dotted","solid","dotdash"), xlab="Objective 1", ylab="Objective 2",  main=i, extra.points=OPTIMAL, extra.pch=16, cex=0.000001, extra.col="red", extra.legend=c("Pareto Front"))
	dev.off()
}
